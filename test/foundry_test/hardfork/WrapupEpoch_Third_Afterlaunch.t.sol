...
contract FirstWraupEpochTest is Test {
  ...
  function testWrapupEpoch_Third_Afterlaunch() external {
    // submitBlockRewardsBulk(5000 wei);
    setThirdPeriodBlock();
    wrapUpEpoch(SkyMavisGVConsensus, 3);
  }

  function setThirdPeriodBlock() internal {
    console.log("[*] Set hardfork block");

    uint256 thirdPeriodBlock = 23193600 - 1; // hardforkBlock + 28800/3 + 28800
    uint256 thridPeriodTimestamp = 1681491913; // Fri, Apr 15 2023 00:05:13 GMT+0000

    __setBlock(thirdPeriodBlock, thridPeriodTimestamp);
  }
